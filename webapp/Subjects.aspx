        ...
        <tr>
            ...
            <td class="RightTD">
                    <hg:HGrid
                        ...
                        KeyField ="Subject_ID"
                        runat="server"
                        Title ="Subjects|<a href='#' onclick='createNewSubject();' class='btn btn-primary'>New Subject</a>"
                        Edit = "false"
                        ...
                        _Required ="Text"
                        Hide="Subject_ID|Category_ID|Docs|Chat"
                        Labels =""
                        _DoNotEdit ="Test_ID|Docs|Chat"
                        _Formats ="Date|MM/dd/yyyy"
                        _ColumnStyle ="Drop_Down_ID|text-align: left;"
                        Widths="default"
                        Calendars="Date"
