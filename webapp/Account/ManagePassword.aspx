<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="ManagePassword.aspx.cs" Inherits="ManagePassword" %>
                ...
                <div class="form-horizontal">
                    ...
                    <div class="form-group row" style="margin-top:2em">
                        <div class="offset-md-2 col-md-10">
                            <asp:Button runat="server" Text="Change Password" ValidationGroup="ChangePassword" OnClick="ChangePassword_Click" CssClass="btn btn-primary form-control" />
                        </div>
                    </div>
                </div>
            </asp:PlaceHolder>
