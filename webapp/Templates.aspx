        ...
        <tr>
            ...
            <td class="RightTD">
                    <hg:HGrid
                        ...
                        runat="server"
                        Title ="Templates|<a href='#' onclick='gridEditorFormNew({element: this, w:400, h:220});' class='btn btn-primary'>New Template</a>"
                        Edit = "false"
                        Links = "Name|gridEditorForm({element: this, w: RelativePixels('w', 1, 400), h: RelativePixels('h', 0.25, 600)})|Fields|displayTemplateFields(this)|Categories|displayTemplateCategories(this)"
                        _Required ="Text"
                        Hide="Form_Template_ID"
                        Labels ="Category_ID|Category"
                        DoNotEdit ="Categories|Fields"
                        _Formats ="Date|MM/dd/yyyy"
                        ColumnStyle ="Field_Count|text-align: center;|Active|text-align: center;|Category_Count|text-align: center;"
                        Widths="default"
                        Calendars="Date"
